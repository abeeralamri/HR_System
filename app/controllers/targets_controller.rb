class TargetsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @target.save
        format.html { redirect_to target_url(@target), notice: t("create") }
  ...
  def update
    respond_to do |format|
      if @target.update(target_params)
        format.html { redirect_to "/targets", notice: t("update")}
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to targets_url, notice: t('destroy')  }
